...
@IBDesignable
open class BeerSelectButton: UIButton {
    ...
    fileprivate func addTargets() {
        ...
        // add target
        //===============
        self.addTarget(self, action: #selector(BeerSelectButton.touchDown(_:)), for: UIControl.Event.touchDown)
        self.addTarget(self, action: #selector(BeerSelectButton.touchUpInside(_:)), for: UIControl.Event.touchUpInside)
        self.addTarget(self, action: #selector(BeerSelectButton.touchDragExit(_:)), for: UIControl.Event.touchDragExit)
        self.addTarget(self, action: #selector(BeerSelectButton.touchDragEnter(_:)), for: UIControl.Event.touchDragEnter)
        self.addTarget(self, action: #selector(BeerSelectButton.touchCancel(_:)), for: UIControl.Event.touchCancel)
    }
    
    @objc func touchDown(_ sender: BeerSelectButton) {
        self.layer.opacity = 0.4
    }
    @objc func touchUpInside(_ sender: BeerSelectButton) {
        self.layer.opacity = 1.0
    }
    @objc func touchDragExit(_ sender: BeerSelectButton) {
        self.layer.opacity = 1.0
    }
    @objc func touchDragEnter(_ sender: BeerSelectButton) {
        self.layer.opacity = 0.4
    }
    @objc func touchCancel(_ sender: BeerSelectButton) {
        self.layer.opacity = 1.0
    }
